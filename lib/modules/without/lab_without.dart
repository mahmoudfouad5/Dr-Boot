...
import 'package:drboot/modules/without/hospital_without.dart';
...
class LabWithOut extends StatefulWidget {
  @override
  State<LabWithOut> createState() => _LabWithOutState();
}

class _LabWithOutState extends State<LabWithOut> {
  int selectedIndex = -1;
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      ...
                                      defualtButton(
                                          onPressed: () {
                                            if (selectedIndex > 0) {
                                              navigatorTo(context, HospitalWithOut());
                                            } else {
