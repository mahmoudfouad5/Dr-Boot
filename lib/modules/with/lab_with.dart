...
import 'package:drboot/modules/with/hospital_with.dart';
...
class LabWith extends StatefulWidget {
  @override
  State<LabWith> createState() => _LabWithState();
}

class _LabWithState extends State<LabWith> {
  int selectedIndex = -1;
                                  ...
                                  Stack(
                                    ...
                                    children: [
                                      ...
                                      defualtButton(
                                          onPressed: () {
                                            if (selectedIndex > 0) {
                                              navigatorTo(context, HospitalWith());
                                            } else {
